                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="{{url('/Courses')}}" ><span> <i class="fas fa-book-open"></i> </span><span class="hide-menu">Courses</span></a></li>
                         ...
                         <li> <a href="{{url('/project')}}" ><span> <i class="fas fa-umbrella"></i> </span><span class="hide-menu">Projects</span></a></li>

                          <li> <a href="{{url('/contact')}}" ><span> <i class="fas fa-address-book"></i> </span><span class="hide-menu">Contact</span></a></li>

                          <li> <a href="{{url('/Review')}}" ><span> <i class="fas fa-umbrella"></i> </span><span class="hide-menu">Review</span></a></li>
